        ...
        <div>
          ...
          <div className='detailes-parent'>
            <div>
              ...
              <p className='p2'>Individual project.</p>
              <p className='p3'><span>Area of Responsibility: </span> All pages</p>
              <h3> <span>Tech Stack : </span> ReactJs | JavaScript | Chakra | React Icons | CSS3</h3>
            </div>
            <div className='btn_div'>
              <a href="https://github.com/aamirkhan9420/fullstack-LMS" target="_blank" rel="noopener noreferrer">
                <button className='btn primary-btn'>GitHub</button>
              </a>
              <a href="https://frontend-ecru.vercel.app/" target='_blank' rel="noreferrer">
                <button className='btn highlighted-btn'>SEE</button>
              </a>
            </div>
          </div>
